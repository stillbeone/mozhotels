...
/**
 * Performance test for the InstanceContact entity.
 */
class InstanceContactGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the InstanceContact entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all instanceContacts")
            .get("/api/instance-contacts")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created instanceContact")
                .get("${new_instanceContact_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created instanceContact")
            .delete("${new_instanceContact_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
