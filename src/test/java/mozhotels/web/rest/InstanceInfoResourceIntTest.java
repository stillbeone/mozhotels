...
public class InstanceInfoResourceIntTest {
    ...
    private static final InfoType DEFAULT_INSTANCE_INFO = InfoType.POLICY;
    ...
    @Test
    @Transactional
    public void checkInstanceInfoIsRequired() throws Exception {
        int databaseSizeBeforeTest = instanceInfoRepository.findAll().size();
        // set the field null
        instanceInfo.setInstanceInfo(null);
